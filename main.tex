...
The latency and throughput results of the tests on the WR cluster are shown in \Cref{fig:lat-comp} and \Cref{fig:rps-comp}.
\vspace{-1em}
\begin{figure}
    \centering
    \begin{minipage}{0.49\textwidth}
    ...
    \end{minipage}
\end{figure}
Similar results are also obtained on Mistral over InfiniBand, as shown in \Cref{fig:lat-comp-mistral} and \Cref{fig:rps-comp-mistral}
\begin{figure}
    \centering
    \begin{minipage}{0.49\textwidth}
        \centering
